...
def optimize_decision_tree():
    ...
    print("Starting Decision Tree optimization with DE on Mushroom dataset...")
    ...
    # Using Differential Evolution instead of PSO
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("OPTIMIZATION COMPLETE! (Decision Tree + DE)")
    print("="*50)
