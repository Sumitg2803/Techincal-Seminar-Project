...
from mealpy.swarm_based import PSO  # PSO Optimizer
...
def optimize_logistic_regression():
    ...
    print("Starting Logistic Regression optimization with PSO on Mushroom dataset...")
    ...
    optimizer = PSO.OriginalPSO(epoch=5, pop_size=20)  # ✅ PSO optimizer
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("OPTIMIZATION COMPLETE! (Logistic Regression + PSO)")
    print("="*50)
