...
from mealpy.swarm_based import GWO  # ✅ Changed optimizer to GWO
...
def optimize_knn():
    ...
    print("Starting K-Nearest Neighbors optimization with GWO on Mushroom dataset...")
    ...
    optimizer = GWO.OriginalGWO(epoch=5, pop_size=20)  # ✅ GWO optimizer
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("OPTIMIZATION COMPLETE! (K-Nearest Neighbors + GWO)")
    print("="*50)
