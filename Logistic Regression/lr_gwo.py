...
from mealpy.swarm_based import GWO  # ✅ GWO Optimizer
...
def optimize_logistic_regression():
    ...
    print("Starting Logistic Regression optimization with GWO on Mushroom dataset...")
    ...
    optimizer = GWO.OriginalGWO(epoch=5, pop_size=20)  # ✅ Changed to GWO Optimizer
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("OPTIMIZATION COMPLETE! (Logistic Regression + GWO)")
    print("="*50)
