...
from mealpy.evolutionary_based import DE  # ✅ Changed optimizer to DE
...
def optimize_knn():
    ...
    print("Starting K-Nearest Neighbors optimization with DE on Mushroom dataset...")
    ...
    optimizer = DE.OriginalDE(epoch=5, pop_size=20)  # ✅ Changed optimizer here
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("OPTIMIZATION COMPLETE! (K-Nearest Neighbors + DE)")
    print("="*50)
