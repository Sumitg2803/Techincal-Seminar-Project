...
from mealpy.swarm_based import FFA  # Firefly Algorithm
...
def objective_function(solution):
    ...
    try:
        ...
        fitness = -np.mean(scores)  # FFA minimizes
    except:
        fitness = 1.0
    return fitness
...
def optimize_random_forest():
    ...
    print("Starting Random Forest optimization with FFA on Mushroom dataset...")
    ...
    optimizer = FFA.OriginalFFA(epoch=5, pop_size=20)
