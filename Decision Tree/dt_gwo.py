...
def optimize_decision_tree():
    ...
    print("Starting Decision Tree optimization with GWO on Mushroom dataset...")
    ...
    problem = {
        "bounds": [
            FloatVar(lb=3, ub=20, name="max_depth"),
            FloatVar(lb=2, ub=15, name="min_samples_split"),
            FloatVar(lb=1, ub=8, name="min_samples_leaf"),
            FloatVar(lb=0.3, ub=0.9, name="max_features")
        ],
        "minmax": "min",
        "obj_func": objective_function
    }

    # Using Grey Wolf Optimizer instead of PSO
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("OPTIMIZATION COMPLETE! (Decision Tree + GWO)")
    print("="*50)
