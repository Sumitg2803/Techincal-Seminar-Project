...
from mealpy.swarm_based import FFA  # FFA optimizer
...
def optimize_svm():
    ...
    print("Starting Support Vector Machine optimization with FFA on Mushroom dataset...")
    ...
    optimizer = FFA.OriginalFFA(epoch=5, pop_size=20)  # FFA optimizer
