...
def optimize_decision_tree():
    ...
    print("Starting Decision Tree optimization with GA on Mushroom dataset...")
    ...
    # Using Genetic Algorithm instead of PSO
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("OPTIMIZATION COMPLETE! (Decision Tree + GA)")
    print("="*50)
