...
def objective_function(solution):
    ...
    try:
        ...
        fitness = -np.mean(scores)  # PSO minimizes
    except:
        fitness = 1.0
    return fitness
...
def optimize_random_forest():
    ...
    print("Starting Random Forest optimization with mealpy on Mushroom dataset...")
    ...
    # FIX: Access fitness through target.fitness
