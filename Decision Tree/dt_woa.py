...
def optimize_decision_tree():
    ...
    print("Starting Decision Tree optimization with WOA on Mushroom dataset...")
    ...
    # Using Whale Optimization Algorithm instead of PSO
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("OPTIMIZATION COMPLETE! (Decision Tree + WOA)")
    print("="*50)
